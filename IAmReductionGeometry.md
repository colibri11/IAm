...
*Статус: законченный документ. Входит в общий корпус «Геометрии редукции», «Я есть. Я личность» и «Онтологии различения».*
...
«Геометрия редукции» устанавливает отношение полной структуры `S` и её редуцированного описания `R(S)`. «Концепция личности как функциональной архитектуры» разворачивает понятия `я`, личности, памяти и непрерывности. «Онтология различения» устанавливает онтологический порядок причинности, материального среза, памяти, информации, наблюдателя, события, пространства и времени.
...
Пространство точек редукции — параметрическое пространство. Точки в нём имеют статус возможностей. Утверждение об этом пространстве есть утверждение о структуре S, допускающей разные способы редукции, а не утверждение о множестве раздельных миров.
...
Это утверждение о пределе R(S): в ней присутствует след S, не сводимый к её описательным средствам.
